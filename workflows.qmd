...
- Nextflow 
  ...
  - Institution cluster configs: https://github.com/nf-core/configs
...
## Multi-ancestry genetic association study (UK Biobank, All of Us, etc) [Nextflow]
...
## Process UK Biobank release [Nextflow]

Turns UKB release object into a DuckDB database  
`https://github.com/mja/ukb-release-nf`
...
## Major depressive disorder GWAS meta-analysis [Snakemake]
...
Code for this talk: `https://github.com/mja/tech-talk-workflows`