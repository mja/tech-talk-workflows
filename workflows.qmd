...
✉️ `mark.adams@ed.uk` 🐘@markjamesadams`@genomic.social` 🦋`@markjamesadams.bsky.social` 𝕏`@mja`
...
Example: Multi-ancestry genetic association study (UK Biobank, AllofUs, etc)
